...
def bfs(node_count: Real, start: Real = 0) -> int:
...
def main() -> None:
    ...
    save_csv(data, "bfs_results.csv")
    save_table(data, "bfs_table.png")
    save_graph(data, "bfs_graph.png")
